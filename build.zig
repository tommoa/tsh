...
pub fn build(b: *std.Build) void {
    ...
    const mod = b.addModule("tsh", .{
        ...
        .target = target,
        // Link libc for POSIX functions like getpid()
        .link_libc = true,
    });
    ...
    const exe = b.addExecutable(.{
        ...
        .root_module = b.createModule(.{
            ...
            // root module.
            .imports = &.{
                // Here "tsh" is the name you will use in your source code to
                // import this module (e.g. `@import("tsh")`). The name is
